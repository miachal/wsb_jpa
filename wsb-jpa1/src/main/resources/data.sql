...
-- Insert patients
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id, is_male, version) VALUES
(1, 'Alice', 'Brown', '111222333', 'alice.brown@example.com', 'PAT001', '1985-05-10', 6, false, 0),
(2, 'Bob', 'Green', '444555666', 'bob.green@example.com', 'PAT002', '1990-08-20', 7, true, 0),
(3, 'Charlie', 'White', '555555555', 'charlie.white@example.com', 'PAT003', '1970-02-15', 8, true, 0),
(4, 'Diana', 'Prince', '666666666', 'diana.prince@example.com', 'PAT004', '1995-11-25', 9, false, 0),
(5, 'Eve', 'Black', '777777777', 'eve.black@example.com', 'PAT005', '1988-03-30', 10, false, 0);
